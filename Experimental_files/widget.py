...
class MyRigging_tools(MayaQWidgetBaseMixin, QtWidgets.QMainWindow):
    # コンストラクタ
    def __init__(self, *args, **kwargs):
        # 親クラスのコンストラクタを呼び出す
        super(MyRigging_tools, self).__init__(*args,**kwargs)
        ...
        self.widget.pB_Create_Curve.clicked.connect(self.generate_curve_1)
